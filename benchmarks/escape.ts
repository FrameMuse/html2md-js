...
import { escapeMarkdown, escapeMarkdownWithReplace, escapeMarkdownFastRegex, escapeMarkdownWithMatchAll, escapeMarkdownWithExec, escapeMarkdownSuperFast } from "../src/utils.ts"

using g1 = bench.group("escapeMarkdown: 6 variants  (0% special chars)")
...
using g2 = bench.group("escapeMarkdown: 6 variants  (5% special chars)")
...
using g3 = bench.group("escapeMarkdown: 6 variants  (50% special chars)")
